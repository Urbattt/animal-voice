function startClassification()
{
  ...
  classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/R9jYvN1iZ/model.json', modelReady);
}
...
function gotResults(error, results) {
  if (error) {
    ...
    if (results[0].label == "woof") {
      ...
      img.src = 'big-mouth-cat.gif';
    
    }
    else if (results[0].label == "moo") {
      img.src = 'efgwergewg.gif';
